...
function FloatingPaths({ position }: { position: number }) {
  const paths = Array.from({ length: 24 }, (_, i) => {
    ...
    const randomDashLength =
      Math.round((60 + seededRandom(seed + 1) * 80) * 100) / 100; // 60-140px long dashes
    const randomGap =
      Math.round((150 + seededRandom(seed + 2) * 100) * 100) / 100; // 150-250px gaps
    const randomDuration =
      Math.round((8 + seededRandom(seed + 3) * 12) * 100) / 100; // 8-20s duration
