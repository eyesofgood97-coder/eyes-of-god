    ...
    <section id="CTA" className="relative py-20 px-4 overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto">
        ...
        >
          ...
          >
            Pushing the Limits of Image Processing
          </h2>
          <p
            className="text-xl text-white/90 mb-8 max-w-2xl mx-auto drop-shadow-md animate-fade-in-up"
            style={{ animationDelay: "0.7s" }}
          >
            Our team specializes in high-resolution image computation,
            transforming terabytes of visual data into clear, actionable
            insights.
          </p>
          <div
